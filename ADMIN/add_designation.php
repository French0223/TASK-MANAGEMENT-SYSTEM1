...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_query = "INSERT INTO designations (title, department, description) VALUES ('$title', '$department', '$description')";
    if (mysqli_query($conn, $insert_query)) {
        header("Location: designation_management.php");
        exit();
    } else {
        $error = "Error adding designation: " . mysqli_error($conn);
    }
}
?>
